...
<button type="submit" class="quantity-btn plus" data-action="plus" data-id="<?=$product['id']?>">+</button>
                    </td>
        ...
        <a href="index.php?page=order" class="btn" id="order-btn">Оформить заказ</a>
